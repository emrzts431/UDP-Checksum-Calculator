...
public class pruefsumme {
	public static void main(String[] args) {
		...
		if(Integer.toBinaryString(result).length() == 16) {
			System.out.println("Summe = "+Integer.toBinaryString(result));
			System.out.println("*******************************************");
			System.out.println("Pruefsumme = "+invert(Integer.toBinaryString(result)));
		}
		else if(Integer.toBinaryString(result).length()>16) {
			int end = makeSixteen(result);
			if(Integer.toBinaryString(end).length()<16) {
				System.out.println("Summe = "+toHexa(end));
				System.out.println("********************************");
				System.out.println("Pruefsumme = "+invert(toHexa(end)));
			}
			else {
				System.out.println("Summe = "+Integer.toBinaryString(end));
				System.out.println("************************************");
				System.out.println("Pruefsumme = "+invert(Integer.toBinaryString(end)));
			}
		}
		else {
			System.out.println("Summe = "+toHexa(result));
			System.out.println("***************************************");
			System.out.println("Pruefsumme = "+invert(toHexa(result)));
		}
	}
